...
#define RTP_DEPACKET_API __attribute__((visibility("default")))
#endif
...
enum e_rtp_depacket_error
{
	...
	e_rtpdepkt_err_nosetparam, //尚未设置参数
	e_rtpdepkt_err_invalidpayload,//错误的payload 
	e_rtpdepkt_err_unsupport ,//未支持
};
