#ifndef _NetBaseNetType_NetClientFFmpegRecv_H
#define _NetBaseNetType_NetClientFFmpegRecv_H
...
{
public:
	CNetClientFFmpegRecv(NETHANDLE hServer, NETHANDLE hClient, char* szIP, unsigned short nPort, char* szShareMediaURL);
    ~CNetClientFFmpegRecv() ;
   ...
   char           szReadFileError[string_length_1024];
   char           szFFmpegErrorMsg[string_length_1024];
